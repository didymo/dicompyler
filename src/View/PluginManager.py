...
class Ui_PluginManager(object):
    def setupUi(self, PluginManager):
        ...
        self.enabledWindow = QtWidgets.QCheckBox(self.centralwidget)
        self.enabledWindow.setGeometry(QtCore.QRect(660, 60, 92, 23))
        self.enabledWindow.setObjectName("enabledWindow")
        self.enabledOrgan = QtWidgets.QCheckBox(self.centralwidget)
        self.enabledOrgan.setGeometry(QtCore.QRect(660, 60, 92, 23))
        self.enabledOrgan.setObjectName("enabledOrgan")
        self.enabledVolume = QtWidgets.QCheckBox(self.centralwidget)
        self.enabledVolume.setGeometry(QtCore.QRect(660, 60, 92, 23))
        self.enabledVolume.setObjectName("enabledVolume")
        self.enabledROI = QtWidgets.QCheckBox(self.centralwidget)
        self.enabledROI.setGeometry(QtCore.QRect(660, 60, 92, 23))
        self.enabledROI.setObjectName("enabledROI")
        self.enabledHash = QtWidgets.QCheckBox(self.centralwidget)
        self.enabledHash.setGeometry(QtCore.QRect(660, 60, 92, 23))
        self.enabledHash.setObjectName("enabledHash")
    ...
    def retranslateUi(self, PluginManager):
        ...
        self.enabledWindow.setText(_translate("PluginManager", "Enabled"))
        self.enabledOrgan.setText(_translate("PluginManager", "Enabled"))
        self.enabledVolume.setText(_translate("PluginManager", "Enabled"))
        self.enabledROI.setText(_translate("PluginManager", "Enabled"))
        self.enabledHash.setText(_translate("PluginManager", "Enabled"))
