...
class Ui_MainWindow(object):
	...
	def setupUi(self, MainWindow, path):
		...
		self.gridLayout_name.addWidget(self.patient_name_box, 0, 1, 1, 1, QtCore.Qt.AlignLeft)
		...
		self.gridLayout_ID.addWidget(self.patient_ID, 0, 0, 1, 1, QtCore.Qt.AlignLeft)
		...
		self.gridLayout_ID.addWidget(self.patient_ID_box, 0, 1, 1, 1, QtCore.Qt.AlignLeft)
		...
		self.gridLayout_gender.addWidget(self.patient_gender, 0, 0, 1, 1, QtCore.Qt.AlignLeft)
