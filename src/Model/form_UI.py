...
class Ui_Form(object):
    def setupUi(self, MainWindow):
        ...
        self.Survival_dt = QtWidgets.QLabel(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "*There was no csv file containing \"clinical data\" in its name located in the directory. Please fill the form below \nfor your selected patient to continue."))
